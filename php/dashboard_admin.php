...
// Vérifie si l'utilisateur n'est pas connecté, n'a pas de profil ou n'est pas admin
if (!isset($_SESSION["Profil"]) || $_SESSION["Profil"] !== "admin" || !isset($_SESSION["id_Utilisateur"])) {
    header("Location: login.php");
    exit;
}

// Inclusion de la connexion PDO (connection.php doit être dans le même dossier que ce fichier)
require_once __DIR__ . '/connection.php'; // fournit $pdo (instance de PDO)
